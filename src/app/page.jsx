...
export default function Home() {
  ...
  return (
    <body className={theme.darkMode ? "dark" : "light"}>
      <div className="grid grid-cols-3 gap-2 md:grid-cols-4 md:gap-4 my-5 container mx-auto xl:px-20  md:p-5">
        ...
        <a className="relative rounded-3xl col-span-2 md:aspect-auto overflow-hidden hover:scale-[103%] transition duration-500 ease-in-out bg-[#1c053a9c]"></a>
      </div>
    </body>
  );
}
